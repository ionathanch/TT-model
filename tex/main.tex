...
Inversion principles for the other types hold as well,
...
We can internalize it by syntactically introducing an eliminator for levels,
but it is unclear whether such an eliminator would be useful.

\iffalse
The eliminator states that a predicate $\ottnt{B}$ holds on arbitrary levels
