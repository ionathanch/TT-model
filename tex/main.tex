...
\begin{itemize}[topsep=0pt]
  ...
  \item Normalization remains an open problem.
...
%
\begin{align*}
   \ottnt{e}  ,  \ottnt{E}  &\Coloneqq \ottmv{x} \mid  \ottnt{e}  \gap  \ottnt{n}  \mid  \kw{absurd}_{ \ottnt{N} } \gap  \ottnt{e}  \\
   \ottnt{n}  ,  \ottnt{N}  &\Coloneqq \ottmv{i} \mid  \Pi  \ottmv{x}  \mathbin{:}  \ottnt{N}  \mathpunct{.}  \ottnt{N}  \mid  \lambda  \ottmv{x}  \mathbin{:}  \ottnt{N}  \mathpunct{.}  \ottnt{n}  \mid  \bot  \mid  \kw{U} \gap  \ottnt{n}  \mid  \kw{Level}\texttt{<} \gap  \ottnt{n}  \mid \ottnt{e}
\end{align*}
