...
The former is expressed by \rref{Sub}, the latter by \rref{Trans}.
...
This does not hold by \rref{Sub} alone:
for instance, a function $\ottmv{f}$ of type $ \kw{U} \gap    7   \to   \kw{U} \gap   8    $ in the context
cannot be assigned type $ \kw{U} \gap    6   \to   \kw{U} \gap   9    $,
although its $\eta$-expansion $ \lambda  \ottmv{x}  \mathpunct{.}   \ottmv{f}  \gap  \ottmv{x}  $ can.
