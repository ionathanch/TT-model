...
as well as its extension to abstractions over (in)equality constraints on levels~\citep{explicit}.
...
we obtain higher-order level polymorphism,
...
\section{A minimal type theory with bounded first-class universe levels}
